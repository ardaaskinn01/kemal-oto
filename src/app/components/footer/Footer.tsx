...
import { Wrench, Phone, Mail, MapPin, ShieldCheck, Lock } from 'lucide-react';
...
export function Footer() {
  return (
    <footer className="bg-white dark:bg-[#0d0f12] text-gray-500 dark:text-gray-500 border-t border-gray-200 dark:border-[#2a2d35] transition-colors">
      ...
      {/* iyzico ile Öde, Visa, MasterCard, Troy ve Amex Güvenlik Bandı */}
      <div className="border-t border-gray-200 dark:border-[#2a2d35] bg-gray-50/70 dark:bg-[#090b0e] py-6 transition-colors">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row items-center justify-between gap-5">
          <div className="flex flex-col sm:flex-row items-center gap-3 text-center sm:text-left">
            ...
            <div>
              <div className="flex items-center justify-center sm:justify-start gap-2 text-xs font-bold text-gray-800 dark:text-gray-200">
                <span className="text-emerald-600 dark:text-emerald-400 flex items-center gap-1">
                  <ShieldCheck className="w-3.5 h-3.5" /> 256-Bit SSL &amp; 3D Secure
                </span>
                <span className="text-gray-300 dark:text-gray-700">•</span>
                <span>iyzico ile Güvenli Ödeme</span>
              </div>
              <p className="text-[11px] text-gray-500 dark:text-gray-400 mt-0.5">
                Tüm kredi ve banka kartlarıyla tek çekim ve taksitli alışveriş yapabilirsiniz. Kart bilgileriniz asla saklanmaz.
              </p>
            </div>
          </div>

          <div className="flex items-center gap-3 shrink-0">
            {/* Light Mode Official Logo Band */}
            <div className="block dark:hidden bg-white px-4 py-2 rounded-xl border border-gray-200/80 shadow-xs">
              <Image
            ...
            {/* Dark Mode Official Logo Band */}
            <div className="hidden dark:block bg-[#12151b] px-4 py-2 rounded-xl border border-[#2a2d35] shadow-xs">
              <Image
