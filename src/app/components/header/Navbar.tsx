  ...
  return (
    <>
      <header className="sticky top-0 z-40 bg-white dark:bg-slate-950 border-b border-slate-200 dark:border-slate-800 transition-colors">
        ...
        {/* 1. Top Utility Strip */}
        <div className="bg-slate-100 dark:bg-slate-900 border-b border-slate-200 dark:border-slate-800/80 text-slate-600 dark:text-slate-400 text-xs py-1.5 px-4">
          <div className="max-w-7xl mx-auto flex items-center justify-between">
            <div className="flex items-center gap-2 text-[11px]">
              <MapPin className="w-3.5 h-3.5 text-orange-600 dark:text-orange-500" />
              <span>Maslak Atatürk Oto Sanayi • Depodan Hızlı Sevk</span>
            </div>
            ...
            <div className="hidden md:flex items-center gap-4 text-[11px] font-medium">
              ...
              <a href="tel:08503000000" className="flex items-center gap-1 hover:text-orange-600 dark:hover:text-orange-400 transition-colors">
                ...
                <span>0850 300 00 00 / Kemal Oto Destek</span>
              </a>
            </div>

            <div className="flex items-center gap-3">
              <Link href="/tracking" className="text-[11px] font-semibold text-slate-700 dark:text-slate-300 hover:text-orange-600 dark:hover:text-orange-400 flex items-center gap-1">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3.5">
          <div className="flex items-center justify-between gap-4 sm:gap-8">
            ...
            <Link href="/" className="flex items-center gap-2.5 shrink-0">
              <div className="w-10 h-10 rounded-lg bg-orange-600 text-white flex items-center justify-center font-black shadow-sm">
              ...
              <div className="flex flex-col">
                ...
                <span className="text-[10px] tracking-wider text-slate-500 uppercase font-semibold mt-0.5">
                  Oto Yedek Parça
                </span>
              </div>
            </Link>

            {/* Search Bar (Clean E-Commerce Standard) */}
            ...
            <div className="flex items-center gap-2 sm:gap-3">
              ...
              <button
                ...
                className={`flex items-center gap-2 text-xs font-semibold px-3 py-2 rounded-lg border transition-all cursor-pointer ${activeVehicle
              ...
              >
                <Car className={`w-4 h-4 ${activeVehicle ? 'text-emerald-600 dark:text-emerald-400' : 'text-orange-600'}`} />
                {activeVehicle ? (
                  <div className="flex flex-col text-left leading-tight">
                    <span className="text-[9px] text-emerald-600 dark:text-emerald-400 font-bold uppercase">Aracım:</span>
                    <span className="truncate max-w-[100px] text-slate-900 dark:text-white font-bold">
              ...
              {isAdmin && (
                <Link
                  href="/admin"
                  className="bg-amber-100 dark:bg-amber-500/20 text-amber-800 dark:text-amber-300 border border-amber-300 dark:border-amber-500/40 text-xs font-bold px-2.5 py-2 rounded-lg transition-all flex items-center gap-1.5"
                >
              ...
              {user ? (
                <div className="flex items-center gap-1.5">
                  <Link
                    href="/garage"
                    className="bg-slate-100 dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-lg px-2.5 py-1.5 hidden sm:flex flex-col text-left text-xs"
                  >
                    <span className="text-[10px] text-slate-500">Hesabım</span>
                    <span className="font-semibold text-slate-900 dark:text-white truncate max-w-[80px]">
                ...
                <Link
                  href="/login"
                  className="flex items-center gap-1.5 text-xs font-semibold text-slate-700 dark:text-slate-200 hover:text-orange-600 bg-slate-100 dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-lg px-3 py-2 transition-all"
                >
              ...
              <Link
                href="/shop"
                className="relative p-2 bg-orange-50 dark:bg-orange-950/30 border border-orange-200 dark:border-orange-500/30 hover:bg-orange-100 text-orange-700 dark:text-orange-400 rounded-lg transition-colors flex items-center gap-1.5"
              >
