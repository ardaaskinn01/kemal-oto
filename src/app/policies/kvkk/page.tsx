    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-10 space-y-8">
      ...
      <div className="space-y-6 text-xs sm:text-sm text-slate-600 dark:text-slate-300 leading-relaxed">
        ...
        <section className="space-y-3">
          ...
          <p>
            6698 sayılı Kişisel Verilerin Korunması Kanunu (&quot;KVKK&quot;) uyarınca, kişisel ve ticari verileriniz veri sorumlusu sıfatıyla Kemal Oto (&quot;Şirket&quot;) tarafından aşağıda açıklanan kapsamda işlenmektedir.
          </p>
        </section>
